...
{
    public class ExpenseFinancialsViewModel : ViewModelBase
    {
        private arapp.AR _ar;
        public ExpenseFinancialsViewModel(SharePointContext spContext, arapp.AR ar)
             : base(spContext)
        {
            if (ar == null)
                ar = new arapp.AR();
